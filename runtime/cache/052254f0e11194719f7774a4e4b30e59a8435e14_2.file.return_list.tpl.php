<?php /* Smarty version 3.1.27, created on 2016-01-16 11:53:11
         compiled from "E:\php\zao\web\zao\template\trade\return_list.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:319025699bea76fb0a4_14732439%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '052254f0e11194719f7774a4e4b30e59a8435e14' => 
    array (
      0 => 'E:\\php\\zao\\web\\zao\\template\\trade\\return_list.tpl',
      1 => 1452916260,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '319025699bea76fb0a4_14732439',
  'variables' => 
  array (
    'order' => 0,
    'item' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5699bea7945022_89173632',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5699bea7945022_89173632')) {
function content_5699bea7945022_89173632 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '319025699bea76fb0a4_14732439';
?>
<!DOCTYPE html>
<html>
<head>
            ...
            <div class="main-container">
                <div class="dm-page-head">
                    ...
                    <ul class="dm-nav-inner">
                        ...
                        <!--li>
                            <a href="?ct=trade&type=5" <?php if ($_GET['type'] == 5) {?>class="current"<?php }?> >退换货</a>
                        </li-->
                        <li>
...
；订单生成时间：<?php echo htmlspecialchars(date('Y-m-d',$_smarty_tpl->tpl_vars['item']->value['ct']), ENT_QUOTES, 'UTF-8');?>
 ...
 邮费：¥<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['postage'], ENT_QUOTES, 'UTF-8');?>
                                    ...
                                    快递公司：<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['express_company'], ENT_QUOTES, 'UTF-8');?>
；单号：<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['express_code'], ENT_QUOTES, 'UTF-8');?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['nickname'], ENT_QUOTES, 'UTF-8');?>
                                ...
                                <td>
                                    <a href="http://www.kuaidi100.com/chaxun?com=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['express_company'], ENT_QUOTES, 'UTF-8');?>
&nu=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['express_code'], ENT_QUOTES, 'UTF-8');?>
